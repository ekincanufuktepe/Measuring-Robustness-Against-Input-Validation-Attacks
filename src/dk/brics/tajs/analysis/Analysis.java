...
public final class Analysis implements IAnalysis<State,Context,CallEdge<State>,Monitoring<State,Context,CallEdge<State>>,Analysis> {
	...
	public void setSolverInterface(Solver.SolverInterface c) {
		...
		System.out.println("WS: "+c.getAnalysisLatticeElement().getCallGraph().getCallGraphStatistics());
		System.out.println("sadf 1- : "+c.getAnalysisLatticeElement().getCallGraph().getNumberOfInvocationsInDifferentContexts()+" asfd 2- :"+c.getAnalysisLatticeElement().getCallGraph().getNumberOfInvocationsInDifferentContextsWithUniqueTarget());
