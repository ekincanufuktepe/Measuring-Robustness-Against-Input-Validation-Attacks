...
public class CallNode extends LoadNode implements ICallNode  {
     ...
     */
    public CallNode(String name, boolean constructor, boolean arraylit, int result_reg, int base_reg, int function_reg, List<Integer> arg_regs, SourceLocation location) {
...
//        this.line = line;
     ...
     * @param location The source location.
     */
    public CallNode(String name, boolean constructor, int result_reg, int base_reg, int property_reg, String property_str, List<Integer> arg_regs, SourceLocation location) {
        super(result_reg, location);
        this.constructor = constructor;
        this.base_reg = base_reg;
